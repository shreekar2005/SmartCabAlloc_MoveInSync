...
Revision ID: 78d6ef21f50d
Revises: 
Create Date: 2025-09-10 02:11:12.051273
...
def upgrade():
    ...
    sa.Column('current_trip_status', sa.String(length=20), nullable=True),
    sa.Column('current_trip_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['current_trip_id'], ['trip.id'], ),
    sa.PrimaryKeyConstraint('id'),
