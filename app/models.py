...
class User(db.Model):
    ...
    current_trip_id = db.Column(db.Integer, db.ForeignKey('trip.id'), nullable=True)
    # actully i did not understand why we need that random name, but that is necessory here ...
